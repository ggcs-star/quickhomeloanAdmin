        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('modules.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Module Image</label>

                        <input type="file" name="image" accept="image/*"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl">

                        <p class="text-xs text-gray-500">Upload module thumbnail/icon</p>
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Color Theme</label>

                        <input type="color" name="color_code" class="w-20 h-10 border rounded">

                        <p class="text-xs text-gray-500">Choose module color</p>
                    </div>
                    <!-- DESCRIPTION FIELD -->
                    <div class="space-y-2">
                        <label class="flex items-center gap-2 text-sm font-medium text-gray-700">
