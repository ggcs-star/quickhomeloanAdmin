...
@section('content')
    <div class="p-6 max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Fill in the details to create a new banner</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form method="POST" action="{{ route('banners.store') }}" enctype="multipart/form-data" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" placeholder="Enter banner title" value="{{ old('title') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="link" id="link" placeholder="https://example.com" value="{{ old('link') }}"
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" placeholder="1, 2, 3..." value="{{ old('order', 0) }}"
                        min="0"
