    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-10 lg:p-14 hidden lg:flex flex-col">
            <div class="flex items-center gap-3 mb-10">
                <div class="w-12 h-12 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center">
        ...
        <div class="p-10 lg:p-14">
            <div class="max-w-md mx-auto">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="email"
                                required
                                class="w-full px-4 py-3 pl-11 rounded-lg border border-gray-300 bg-gray-50
                                       focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500
                                       focus:outline-none transition"
                                placeholder="admin@quickhomelon.in"
                            >
                    ...
                    <button
                        type="submit"
                        class="w-full py-3.5 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600
