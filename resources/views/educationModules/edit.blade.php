        ...
        <div class="px-8 py-5 border-b border-gray-200 bg-gradient-to-r from-indigo-50/50 to-transparent">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Last updated: {{ $module->updated_at ? $module->updated_at->diffForHumans() : 'Never' }}</p>
                </div>
            </div>
        </div>

        <!-- FORM BODY -->
        <form action="{{ route('modules.update', $module->_id) }}" method="POST" class="p-8">
            @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="status"
                            ...
                            <option value="1" {{ $module->status ? 'selected' : '' }}>✅ Active - Visible to users</option>
                            <option value="0" {{ !$module->status ? 'selected' : '' }}>⏸️ Inactive - Hidden from users</option>
                        </select>
                    </div>
